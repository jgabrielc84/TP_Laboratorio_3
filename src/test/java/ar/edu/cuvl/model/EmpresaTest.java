...
class EmpresaTest {
    ...
    Cliente cliente;
    Pedido pedido;
    ReparacionCompleja limpiezaCompleja;
    ...
    void setUp(){
        ...
        cliente = new Cliente(567777,tipoServicio,LocalDateTime.now(),2,1);
        ReparacionCompleja limpiezaCompleja = new ReparacionCompleja();
        ArrayList<TipoSuperficie> tipoSuperficies = new ArrayList<>();
        pedido = new Pedido(5, cliente,"calle falsa 123",2, new ArrayList<>(), new ArrayList<>());
